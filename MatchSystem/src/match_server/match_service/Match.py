...
class Iface(object):
    def add_player(self, scoer, uuid, username, photo, channel_name):
        """
        Parameters:
         - scoer
         - uuid
...
class Client(Iface):
    ...
    def add_player(self, scoer, uuid, username, photo, channel_name):
        ...
        """
        self.send_add_player(scoer, uuid, username, photo, channel_name)
        return self.recv_add_player()

    def send_add_player(self, scoer, uuid, username, photo, channel_name):
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.scoer, args.uuid, args.username, args.photo, args.channel_name)
...
class add_player_args(object):
    ...
    def __init__(self, scoer=None, uuid=None, username=None, photo=None, channel_name=None,):
        self.scoer = scoer
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if self.scoer is not None:
            oprot.writeFieldBegin('scoer', TType.I32, 1)
            oprot.writeI32(self.scoer)
            oprot.writeFieldEnd()
